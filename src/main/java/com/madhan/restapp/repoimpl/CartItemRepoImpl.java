...
public class CartItemRepoImpl implements CartItemRepo {
    ...
    public CartItem save(CartItem cartItem) {
        try {
            ...
            e.printStackTrace();
            return null; // Consider throwing a custom exception or handling it appropriately
        }
    }
    ...
    public Optional<CartItem> findById(Long id) {
        try {
            ...
            e.printStackTrace();
            return Optional.empty(); // Consider throwing a custom exception or handling it appropriately
        }
    }
